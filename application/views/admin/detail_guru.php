...
<head>
	...
	<title>Data Detail Guru - SPP Pondok </title>
	<!-- General CSS Files -->
				...
				<section class="section">
					...
					<div id="detail" class="col-md-12 bg-white p-3"
						...
						<p class="text-center" style="line-height: 5px;">Berikut data detail yang terdapat di
							database, meliputi NIP, Nama dan Email</p>
						<hr>
						<table class="container text-center">
							<tbody>
								...
								<tr style="border-bottom:1px solid #6c757d; margin : 10px;">
						...
						<a href="<?= base_url('admin/data_guru') ?>" class="btn btn-primary btn-block">Kembali</a>
					</div>
				</section>
			</div>
		</div>
