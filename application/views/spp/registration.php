...
<head>
	...
	<title>Tambah Data Guru - SPP Pondok</title>
	<!-- General CSS Files -->
				...
				<section class="section">
					<div class="">
						<div class="card" style="width:100%;">
							<div class="card-body">
								<h2 class="card-title" style="color: black;">Tambah Data SPP</h2>
							</div>
						</div>
					</div>
					...
					<div id="detail" class="card card-primary">
						...
						<div class="card-body">
							<form method="POST" action="<?= base_url('admin/add_spp') ?>">
								<div id="" class="form-group">
									<label for="bulan">Bulan</label>
									<input id="bulan" type="text" class="form-control" name="bulan">
								...
								<div class="form-group">
									...
									<input id="tahun" type="tahun" class="form-control" name="tahun">
